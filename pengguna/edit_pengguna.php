...
global $conn;
$id_pegawai = $_GET['kode_pegawai'];
$pegawai = query("SELECT * from pegawai WHERE kode_pegawai='$id_pegawai'")[0]; //pada akhira  qury menambahkan array index nol, di karenakan array yang doi hasilkan query merupakan arrya numerik yang indexnya 0
