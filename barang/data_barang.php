            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Keseluruhan Barang yang dijual</li>
                    </ol>
                    <?php
...
?>
                    ...
                    require '../barang/fungsi_barang.php';
                     global $conn;
                        $barang = query("select barang.*,jenis_barang.jenis_barang FROM barang JOIN jenis_barang ON jenis_barang.kode_jenis=barang.kode_jenis");
                        ...
                        <tbody>
                            ...
                            <?php foreach ($barang as $brg) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $brg["jenis_barang"]; ?></td>
                              
                                    <td class="text-center">
                                        <a class="btn btn-danger" href="../barang/hapus_barang.php?kode_barang=<?=$brg["kode_barang"]; ?>" onclick="return confirm('apakah anda yakin')" role="button"><i class="fas fa-trash">
                                                </i>hapus</a>|
                                        <a class="btn btn-warning" href="../barang/edit_barang.php?kode_barang=<?= $brg["kode_barang"]; ?>" role="button"><i class="fas fa-edit"></i>edit</a>|
                                        <a class="btn btn-primary" href="../barang/detail_barang.php?kode_barang=<?= $brg["kode_barang"]; ?>" role="button"><i class="fas fa-eye"></i>detail</a>|
                                    </td>
                                </tr>
