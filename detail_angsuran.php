    ...
    <div id="layoutSidenav_nav">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <h1 class="mt-4">Detail Laporan Detail Angsuran</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Daftar Pembayaran Angsuran</li>
                    </ol>
                    <a  class="btn btn-outline-danger mb-4" href="../laporan/angsuran.php" >Kembali</a> 
                   
             <table class="table table-bordered">

                    <?php
                    require '../laporan/fungsi_laporan.php';
                    $kode_pelanggan = $_GET['no_ktp'];
                     global $conn;
                        $barang = query("SELECT pelanggan.nama_pelanggan, 
                        riwayat_angsuran.angsuran_ke, 
                        riwayat_angsuran.denda, 
                        riwayat_angsuran.jumlah_bayar, 
                        riwayat_angsuran.tgl_bayar, 
                        pegawai.nama 
                 FROM riwayat_angsuran 
                 JOIN pelanggan ON pelanggan.no_ktp = riwayat_angsuran.no_ktp 
                 JOIN pegawai ON pegawai.kode_pegawai = riwayat_angsuran.kode_pegawai 
                 WHERE pelanggan.no_ktp = '$kode_pelanggan';
                        ...
                        <tbody>
                            ...
                            <?php foreach ($barang as $brg) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $brg["angsuran_ke"]; ?></td>
                                    <td class="text-center"><?= $brg["denda"]; ?></td>
                                    <td class="text-center"><?= $brg["jumlah_bayar"]; ?></td>
                                    
                                    <td class="text-center"><?= $brg["tgl_bayar"]; ?></td>
