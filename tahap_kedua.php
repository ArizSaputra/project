            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Daftar Pelanggan Pembayaran Angsuran</li>
                    </ol>
              ...
              <table class="table table-bordered">
                    ...
                    require '../laporan/fungsi_laporan.php';
                     global $conn;
                        $pengguna = query("SELECT DATE_FORMAT(riwayat_angsuran.tgl_bayar, '%M %Y') AS bulan_pendapatan, COUNT(riwayat_angsuran.id_riwayat) AS jumlah_pendapatan, SUM(riwayat_angsuran.jumlah_bayar+riwayat_angsuran.denda) AS total_pendapatan FROM riwayat_angsuran  GROUP BY bulan_pendapatan
                        ;");
                    ...
                    ?>
                        ...
                        <thead class="text-center">
                            <tr>
                                <td>Nomor</td>
                                <td>Bulan Pendapatan</td>
                                <td>Total Transaksi Pendapatan</td>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($pengguna as $pgn) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $pgn["bulan_pendapatan"]; ?></td>
                                    <td class="text-center"><?= $pgn["jumlah_pendapatan"]; ?></td>
                                    <td class="text-center"><?= $pgn["total_pendapatan"]; ?></td>
                                    <td class="text-center">
                                        
                                        <a class="btn btn-primary" href="../laporan/detail_kedua.php?bulan_pendapatan=<?= $pgn["bulan_pendapatan"]; ?>" role="button"><i class="fas fa-eye"></i></i>Detail</a>|
                                    </td>
                                </tr>
