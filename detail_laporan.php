    ...
    <div id="layoutSidenav_nav">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <h1 class="mt-4">Detail Laporan Pengeluaran</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Daftar Pembelian Barang</li>
                    </ol>
                    <a  class="btn btn-outline-danger mb-4" href="../laporan/tahap_awal.php" >Kembali</a> 
                   
             <table class="table table-bordered">

                    <?php
                    require '../laporan/fungsi_laporan.php';
                    $bulan_pembelian = $_GET['bulan_pembelian'];
                     global $conn;
                        $barang = query("SELECT
                        DATE_FORMAT(pembelian.tgl_pembelian, '%M %Y') AS bulan_pembelian,
                        pembelian.tgl_pembelian,
                        Barang.nama_barang,
                        barang.harga_jual AS total_pembelian,
                        pembelian.nama_toko,
                        pembelian.alamat_toko
                    FROM
                        pembelian
                    JOIN
                        barang ON barang.kode_barang = pembelian.kode_barang
                    WHERE
                        DATE_FORMAT(pembelian.tgl_pembelian, '%M %Y') = '$bulan_pembelian'
                    GROUP BY
                        ...
                        <tbody>
                            ...
                            <?php foreach ($barang as $brg) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $brg["tgl_pembelian"]; ?></td>
                                    <td class="text-center"><?= $brg["nama_barang"]; ?></td>
                                    <td class="text-center"><?= $brg["total_pembelian"]; ?></td>
                                    <td class="text-center"><?= $brg["nama_toko"]; ?></td>
                                    <td class="text-center"><?= $brg["alamat_toko"]; ?></td>
