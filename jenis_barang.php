        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Daftar Jenis Barang</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Data Jenis Yang Terdaftar</li>
                    </ol>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($jenis_brg as $jnb) :
                                $id_jenisss = $jnb["kode_jenis"];
                            ?>

                                <tr>
                                    <th scope="row" class="text-center"><?= $no++; ?></th>
                                    <td class="text-center"><?= $jnb["jenis_barang"]; ?></td>
                                    <td class="text-center">
                                        <a class="btn btn-danger" href="hapus_jenis.php?kode_jenis=<?= $jnb["kode_jenis"]; ?>" onclick="return confirm('apakah anda yakin')" role="button"><i class="fas fa-trash"></i>hapus</a>|
                                        <a class="btn btn-warning" href="edit_jenis.php?kode_jenis=<?= $jnb["kode_jenis"]; ?>" role="button"><i class="fas fa-edit"></i>edit</a>|
                                    </td>
                                </tr>
