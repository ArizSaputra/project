        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Verifikasi Pemesanan</h1>
...
?>
        ...
        <table class="table table-bordered">
                    ...
                    require '../barang/fungsi_restoknew.php';
                     global $conn;
                        $barang = query("SELECT angsuran.kode_angsuran, pelanggan.nama_pelanggan, pelanggan.alamat, pelanggan.no_hp, angsuran.detail_barang, detail_angsuran.lama_angsuran from angsuran join detail_angsuran 
                        on angsuran.kode_angsuran=detail_angsuran.kode_angsuran
                        join pelanggan on pelanggan.no_ktp=angsuran.no_ktp WHERE status='pengajuan';");
                        ...
                        <tbody>
                            ...
                            <?php foreach ($barang as $brg) :?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $brg["kode_angsuran"]; ?></td>
                                    <td class="text-center"><?= $brg["nama_pelanggan"]; ?></td>
                                    <td class="text-center"><?= $brg["alamat"]; ?></td>
                                    <td class="text-center"><?= $brg["no_hp"]; ?></td>
                                    <td class="text-center"><?= $brg["detail_barang"]; ?></td>
                                    <td class="text-center"><?= $brg["lama_angsuran"]; ?></td>
                              
                                    <td class="text-center">
                                    <a class="btn btn-warning" href="../barang/edit_restok.php?kode_angsuran=<?= $brg["kode_angsuran"]; ?>"><i class="fas fa-edit"></i>Setuju</a>|
                                        <a class="btn btn-danger" href="../barang/restoknew.php.php?kode_angsuran=<?=$brg["kode_angsuran"]; ?>" onclick="return confirm('apakah anda yakin')" role="button"><i class="fas fa-trash">
                                                </i>Hapus</a>|
